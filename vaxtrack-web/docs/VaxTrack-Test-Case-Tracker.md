...
| RTE-003 | Security | Dispatcher | Firestore rules | Dispatcher may write route fields | Rules deployed | Update order with route* fields | Allowed (in `dispatcherOrderFields`) | Emulator test **P13** passes | Passed | `test:rules` 24/24 |
